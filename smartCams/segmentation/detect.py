...
def main(argv):
    ...
    parser.add_argument(
        ...
        default=os.path.join(pycaffe_dir,
                "../models/bvlc_reference_rcnn_ilsvrc13/deploy.prototxt"), # rcnn, not caffenet (original is caffenet)
        help="Model definition file."
    )
    parser.add_argument(
        "--pretrained_model",
        default=os.path.join(pycaffe_dir,
                "../models/bvlc_reference_rcnn_ilsvrc13/bvlc_reference_rcnn_ilsvrc13.caffemodel"), # rcnn, not caffenet (original is caffenet)
    ...
    parser.add_argument(
        "--mean_file",
        default=os.path.join(pycaffe_dir,
                             'caffe/imagenet/ilsvrc_2012_mean.npy'), # TODO: update
